"""
run_spatial_hiding.py — Test de la contre-mesure Spatial Hiding
"""
import sys, os
...
EXTRA_OPTS = ''                  # Plus besoin de flags, tout est dynamique
N_TRACES   = 150
...
if __name__ == '__main__':
    ...
    try:
        ...
        # 4. Capture des traces
        # La STM32 choisit elle-même sa config à chaque itération
    ...
    # 5. Graphe trace brute (échelle fixe)
    plot_trace(traces,title=f'{LABEL} ({PLATFORM})',filename=f'trace_{PLATFORM}_config{CONFIG}.png',ylim=(-0.5, 0.5))
