"""
run_config_F.py — Config F : Clé AES en CCM, Pile (Stack) en CCM
Clé AES : CCM | S-Box : SRAM | Variables temporaires (Pile) : CCM
"""
import sys, os
...
EXTRA_OPTS = 'USE_CCM_KEY -DUSE_CCM_STACK'
N_TRACES   = 50
CONFIG     = 'F'
ATTACK_MODE= 'CPA'               # ← 'CPA' ou 'DPA'
LABEL      = 'Config F — Clé CCM, Pile CCM, S-Box SRAM'
# ──────────────────────────────────────────────────────────
...
if __name__ == '__main__':
    ...
    best_key, max_corr, _, _ , _ = _attack_fn(traces, plaintexts)
