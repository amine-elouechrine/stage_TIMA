"""
run_spatial_hiding_F3.py — Contre-mesure Spatial Hiding sur STM32F3
...
if __name__ == '__main__':
    ...
    SN_F3 = "50203120324136503130352030313031"
    ...
    for iteration in range(NB_ITERATIONS):
        ...
        try:
            scope, target = setup_scope(PLATFORM, sn=SN_F3)
        ...
        for mode in ATTACK_MODES:
            ...
            best_key, max_corr, _, _ = _attack_fns(traces_shuffled, plaintexts_shuffled)
            print_summary(
