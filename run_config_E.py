"""
run_config_E.py — Config E : Pile (Stack) entière en CCM
Clé AES : SRAM | S-Box : SRAM | Variables temporaires (Pile) : CCM
"""
import sys, os
...
EXTRA_OPTS = 'USE_CCM_STACK'
N_TRACES   = 50
CONFIG     = 'E'
ATTACK_MODE= 'CPA'               # ← 'CPA' ou 'DPA'
LABEL      = 'Config E — Pile (Stack) en CCM'
# ──────────────────────────────────────────────────────────
