"""
run_config_H.py — Config H : Tout en CCM
Clé AES : CCM | S-Box : CCM | Variables temporaires (Pile) : CCM
"""
import sys, os
...
EXTRA_OPTS = 'USE_CCM -DUSE_CCM_STACK'
N_TRACES   = 50
CONFIG     = 'H'
ATTACK_MODE= 'CPA'               # ← 'CPA' ou 'DPA'
LABEL      = 'Config H — Tout CCM (Clé, S-Box, Pile)'
# ──────────────────────────────────────────────────────────
